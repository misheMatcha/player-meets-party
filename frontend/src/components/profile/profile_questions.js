...
export const PROFILE_QUESTIONS = [
  ...
  [`Current goal`, `What I'm doing with my life`, `One day, I would like to`, `I'd like to known for my`, `If money were no concern, this is what I would be doing`, `My dream job is`],
